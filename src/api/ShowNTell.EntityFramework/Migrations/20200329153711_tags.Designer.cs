...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ShowNTell.Domain.Models.ImagePostTag", b =>
                {
                    b.Property<int>("ImagePostId")
                        .HasColumnType("int");
                    ...
                    b.HasKey("ImagePostId", "TagId");

                    b.HasIndex("TagId");

                    b.ToTable("ImagePostTag");
                });
            ...
            modelBuilder.Entity("ShowNTell.Domain.Models.Tag", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("ShowNTell.Domain.Models.ImagePostTag", b =>
                {
                    ...
                    b.HasOne("ShowNTell.Domain.Models.Tag", "Tag")
                        .WithMany("ImagePosts")
                        .HasForeignKey("TagId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
