!function (e, t) {
  "object" == typeof exports && "undefined" != typeof module ? t(exports) : "function" == typeof define && define.amd ? define(["exports"], t) : t((e = e || self).Vaadin = e.Vaadin || {});
}(this, function (e) {
  "use strict";
    ...
    return o(e, [{
      ...
      value: function (e) {
        ...
        function u(e) {
          ...
          return a = i || r.next(l), i = null, e || !a.done && function (e, t) {
            ...
            if (n && !n.__synthetic) {
              ...
              if (e.chain) {
                if (n.parent) for (var a = e.chain.length; a-- && e.chain[a].route && e.chain[a].route !== n.parent;) e.chain.pop();
              } else e.chain = [];
        ...
        return n.next = u, Promise.resolve().then(function () {
          ...
          if (e ? console.warn(n) : e = new Error(n), e.context = e.context || c, e instanceof DOMException || (e.code = e.code || 500), t.errorHandler) return c.result = t.errorHandler(e), c;
          throw e;
        });
      }
    }, {
  ...
  function ee(e) {
    ...
    if (!(e instanceof J)) throw new TypeError("An instance of Resolver is expected");
    var n = new Map();
    return function (r, o) {
      var a = Y(n, r);
      ...
      if (!i) {
        ...
        for (var s = G.parse(c), h = G.tokensToFunction(s), f = Object.create(null), d = 0; d < s.length; d++) E(s[d]) || (f[s[d].name] = !0);
  ...
  var pe = function (e) {
    function r(e, t) {
      ...
      }, t)), (o = !u || "object" != typeof u && "function" != typeof u ? c(i) : u).resolveRoute = function (e) {
    ...
    return function (e, t) {
      ...
      value: function (e) {
        ...
        b(n.children) && (r = r.then(function () {
          ...
          ie(e) || b(n.children) || (e = n.children), function (e, t) {
            ...
            for (var n = s(e), r = 0; r < n.length; r++) _(n[r]), t.__children.push(n[r]);
          }(e, n);
        }));
        var o = {
          redirect: function (t) {
        ...
        return r.then(function () {
          ...
          return ie(e) && (e instanceof HTMLElement || e.redirect || e === C) ? e : E(n.redirect) ? o.redirect(n.redirect) : n.bundle ? (t = n.bundle, E(t) ? g(t) : Promise.race(p.filter(function (e) {
            return e in t;
          }).map(function (e) {
            return g(t[e], e);
      ...
      value: function (e) {
        var n = this,
            r = e.result;
        return r instanceof HTMLElement ? (function (e, t) {
          t.location = ce(e);
        ...
        }) : r instanceof Error ? Promise.reject(r) : Promise.reject(new Error(h('Invalid route resolution result for path "'.concat(e.pathname, '". ') + 'Expected redirect object or HTML element, but got: "'.concat(function (e) {
      ...
      value: function (e) {
        ...
        if (e.__divergedChainIndex = 0, e.__skipAttach = !1, r.length) {
          ...
          if (e.__skipAttach = o.length === r.length && e.__divergedChainIndex == o.length && this.__isReusableElement(e.result, n.result), e.__skipAttach) {
            for (var l = o.length - 1; l >= 0; l--) r[l].path === o[l].path && e.search === n.search || (a = this.__runOnBeforeLeaveCallbacks(a, e, {
              prevent: i
            }, r[l]));

            for (var s = 0; s < o.length; s++) r[s].path === o[s].path && e.search === n.search || (a = this.__runOnBeforeEnterCallbacks(a, e, {
              prevent: i,
              redirect: c
            }, o[s])), r[s].element.location = ce(e, r[s].route);
          } else for (var h = r.length - 1; h >= e.__divergedChainIndex; h--) a = this.__runOnBeforeLeaveCallbacks(a, e, {
            prevent: i
          }, r[h]);
        }

        if (!e.__skipAttach) for (var f = 0; f < o.length; f++) f < e.__divergedChainIndex ? f < r.length && r[f].element && (r[f].element.location = ce(e, r[f].route)) : (a = this.__runOnBeforeEnterCallbacks(a, e, {
          prevent: i,
          redirect: c
      ...
      value: function () {
        ...
        if (!(e instanceof Node)) throw new TypeError(h("Expected router outlet to be a valid DOM Node (but got ".concat(e, ")")));
      }
    }, {
      ...
      value: function (e) {
        for (var t, n = (this.__disappearingContent || [])[0], r = (this.__appearingContent || [])[0], o = [], a = e.chain, i = a.length; i > 0; i--) if (a[i - 1].route.animate) {
